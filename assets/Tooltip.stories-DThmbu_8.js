import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-BKpi8Zge.js";import{r as V}from"./index-DuoL47QS.js";import{B as l}from"./Button-BF6hd8ru.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CuTHX-aT.js";const n=({content:m,placement:d="top",children:N,portal:I=!0})=>{const B=p.useId(),T=p.useRef(null),E=p.useRef(null),[_,C]=p.useState(!1),w=_,[H,S]=p.useState({}),f=!(m==null||typeof m=="string"&&m.trim()===""),y=8;p.useEffect(()=>{if(!f)return;const t=T.current;if(!t)return;const c=()=>C(!0),a=()=>C(!1);return t.addEventListener("mouseenter",c),t.addEventListener("mouseleave",a),t.addEventListener("focus",c),t.addEventListener("blur",a),()=>{t.removeEventListener("mouseenter",c),t.removeEventListener("mouseleave",a),t.removeEventListener("focus",c),t.removeEventListener("blur",a)}},[f]),p.useEffect(()=>{if(!w)return;const t=()=>{const c=T.current,a=E.current;if(!c||!a)return;const r=c.getBoundingClientRect(),u=a.offsetWidth,v=a.offsetHeight;let o=0,i=0;d==="top"?(o=r.top-y-v,i=r.left+r.width/2-u/2):d==="bottom"?(o=r.bottom+y,i=r.left+r.width/2-u/2):d==="left"?(o=r.top+r.height/2-v/2,i=r.left-y-u):(o=r.top+r.height/2-v/2,i=r.right+y);const s=8,L=window.innerWidth,P=window.innerHeight;i<s&&(i=s),i+u>L-s&&(i=L-s-u),o<s&&(o=s),o+v>P-s&&(o=P-s-v),S({left:Math.round(i),top:Math.round(o)})};return t(),window.addEventListener("scroll",t,!0),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t,!0),window.removeEventListener("resize",t)}},[w,d]);const D=e.jsx("span",{className:"beaver-tooltip__trigger",ref:T,"aria-describedby":f?B:void 0,tabIndex:0,children:N}),R=f?e.jsxs("div",{ref:E,role:"tooltip",id:B,className:"beaver-tooltip__content","data-placement":d,"data-state":w?"visible":"hidden",style:H,children:[e.jsx("div",{className:"beaver-tooltip__inner",children:m}),e.jsx("div",{className:"beaver-tooltip__arrow","data-placement":d})]}):null;return e.jsxs("span",{className:`beaver-tooltip beaver-tooltip--placement-${d}`,children:[D,I&&R?V.createPortal(R,document.body):R]})};n.__docgenInfo={description:`Tooltip 组件
- 使用场景：为元素提供简洁的文字提示信息
- 支持多种位置（上/下/左/右）
- 支持 React 节点内容
- 支持 portal 渲染，避免裁切问题
- 支持内容为空时不显示 Tooltip`,methods:[],displayName:"Tooltip",props:{content:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"要展示的内容，可以是字符串或 React 节点"},placement:{required:!1,tsType:{name:"union",raw:"'top' | 'bottom' | 'left' | 'right'",elements:[{name:"literal",value:"'top'"},{name:"literal",value:"'bottom'"},{name:"literal",value:"'left'"},{name:"literal",value:"'right'"}]},description:"显示位置，默认为 `top`",defaultValue:{value:"'top'",computed:!1}},children:{required:!0,tsType:{name:"ReactReactElement",raw:"React.ReactElement"},description:"子元素：触发 Tooltip 的元素（通常是按钮或文本）"},portal:{required:!1,tsType:{name:"boolean"},description:"是否通过 portal 渲染到 body（默认 true，避免被父容器裁剪）",defaultValue:{value:"true",computed:!1}}}};const O={title:"Components/Tooltip",component:n,tags:["autodocs"]},h={name:"上方 (默认)",render:()=>e.jsx("div",{style:{display:"flex",justifyContent:"center",padding:40},children:e.jsx(n,{content:"这是一个提示（上方）",children:e.jsx(l,{variant:"primary",children:"Hover me"})})})},g={name:"不同位置示例",render:()=>e.jsx("div",{style:{display:"flex",justifyContent:"center",padding:40},children:e.jsxs("div",{style:{display:"flex",gap:24,alignItems:"center"},children:[e.jsx(n,{content:"左侧提示",placement:"left",children:e.jsx(l,{variant:"primary",children:"Left"})}),e.jsx(n,{content:"下方提示",placement:"bottom",children:e.jsx(l,{variant:"primary",children:"Center"})}),e.jsx(n,{content:"右侧提示",placement:"right",children:e.jsx(l,{variant:"primary",children:"Right"})})]})})},x={name:"React节点内容",render:()=>e.jsx("div",{style:{display:"flex",justifyContent:"center",padding:40},children:e.jsx(n,{content:e.jsxs("div",{children:[e.jsx("strong",{style:{color:"blue"},children:"提示标题"}),e.jsx("p",{style:{margin:0},children:"这是提示的详细描述，可以包含多行文本和其他 React 节点。"})]}),placement:"right",children:e.jsx(l,{variant:"primary",children:"Hover me"})})})},j={name:"Portal 对比（裁切与局部样式继承）",render:()=>e.jsx("div",{style:{display:"flex",justifyContent:"center",padding:24},children:e.jsx("div",{style:{border:"1px dashed #cbd5e1",width:360,height:120,overflow:"hidden",position:"relative",display:"flex",alignItems:"center",justifyContent:"center","--beaver-components-tooltip-bg":"orange"},children:e.jsxs("div",{style:{display:"flex",gap:24,alignItems:"center"},children:[e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("div",{style:{marginBottom:8},children:"Portal（默认）"}),e.jsx(n,{content:"这是 portal=true（会渲染到 body，不继承局部变量，且不会被裁切）",placement:"top",children:e.jsx(l,{variant:"primary",children:"Portal"})})]}),e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx("div",{style:{marginBottom:8},children:"No Portal（portal=false）"}),e.jsx(n,{content:"这是 portal=false（在父容器内渲染，会继承局部变量，并可能在某些场景被裁切而无法看到）",placement:"top",portal:!1,children:e.jsx(l,{variant:"primary",children:"In-Place"})})]})]})})})},b={name:"禁用状态（无内容）",render:()=>e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"当content为null/undefined/空字符串时，Tooltip 不显示。"}),e.jsx("div",{style:{display:"flex",justifyContent:"center",padding:40},children:e.jsx(n,{content:"",placement:"top",children:e.jsx(l,{variant:"primary",children:"Hover me"})})})]})};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: '上方 (默认)',
  render: () => <div style={{
    display: 'flex',
...
}`,...b.parameters?.docs?.source}}};const $=["Top","DifferentPlacements","WithReactNode","PortalComparison","Disabled"];export{g as DifferentPlacements,b as Disabled,j as PortalComparison,h as Top,x as WithReactNode,$ as __namedExportsOrder,O as default};
