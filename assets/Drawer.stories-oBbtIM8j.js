import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as o,R as b}from"./iframe-Cewsh_J1.js";import{C as G}from"./Close-IiX-HAFp.js";import{r as J}from"./index-CdKLuNko.js";import{B as l}from"./Button-DYo4OVnm.js";import{I as B}from"./Input-CrQFdk2o.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B3TxT0Au.js";import"./Eye-OPWQ-oqv.js";function Q(t){const[r,a]=o.useState(!1),[i,s]=o.useState(!1);return o.useEffect(()=>{if(t)if(r)i||s(!0);else{a(!0);const n=setTimeout(()=>{const j=setTimeout(()=>{s(!0)},10);return()=>clearTimeout(j)},0);return()=>clearTimeout(n)}else{s(!1);const n=setTimeout(()=>{t||a(!1)},250);return()=>clearTimeout(n)}},[t,r,i]),{mounted:r,animating:i}}const S=b.forwardRef(({title:t,closable:r,onClose:a,id:i},s)=>e.jsxs("div",{className:"beaver-drawer__header",ref:s,children:[t&&e.jsx("h2",{className:"beaver-drawer__title",id:i,children:t}),r&&e.jsx("button",{className:"beaver-drawer__close",onClick:a,"aria-label":"关闭抽屉",type:"button",children:e.jsx(G,{width:"1em",height:"1em","aria-hidden":!0})})]}));S.displayName="DrawerHeader";S.__docgenInfo={description:`DrawerHeader 组件
- 用于展示Drawer的标题和关闭按钮
...
- 用于放置Drawer底部的操作按钮
- 内部组件，通常由Drawer自动创建，也可独立使用`,methods:[],displayName:"DrawerFooter",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"页脚内容，通常为按钮等操作元素"}}};const O=b.forwardRef(({children:t,container:r},a)=>{if(typeof document>"u")return null;const i=r||document.body;return J.createPortal(e.jsx("div",{ref:a,className:"beaver-drawer-portal",children:t}),i)});O.displayName="Portal";O.__docgenInfo={description:`Portal 组件
- 用于将组件内容挂载到 DOM 的其他位置（通常为 body）
- 用于Drawer、Modal等需要脱离文档流的组件
- 避免z-index和overflow属性的层级问题`,methods:[],displayName:"Portal",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Portal容器内的内容"},container:{required:!1,tsType:{name:"union",raw:"HTMLElement | null",elements:[{name:"HTMLElement"},{name:"null"}]},description:"容器元素，默认为document.body"}}};const U={small:"240px",medium:"360px",large:"520px"},d=b.forwardRef(({open:t=!1,onClose:r,title:a,width:i,placement:s="right",size:n="medium",closable:j=!0,maskClosable:T=!0,children:_,footer:C,className:z="",maskClassName:q="",contentClassName:E="",offset:p=0,mask:F=!0,...P},W)=>{const{mounted:k,animating:R}=Q(t),$=o.useRef(null),V=m=>{T&&r&&r()};if(o.useEffect(()=>{if(!t)return;const m=K=>{K.key==="Escape"&&r&&r()};return document.addEventListener("keydown",m),()=>document.removeEventListener("keydown",m)},[t,r]),o.useEffect(()=>{if(k){const m=window.innerWidth-document.documentElement.clientWidth;return document.body.style.overflow="hidden",document.body.style.paddingRight=`${m}px`,()=>{document.body.style.overflow="",document.body.style.paddingRight=""}}},[k]),!k)return null;const M=i||U[n],c={[s==="left"||s==="right"?"width":"height"]:M};p&&p>0&&(s==="left"?c.left=p:s==="right"?c.right=p:s==="top"?c.top=p:s==="bottom"&&(c.bottom=p));const I=`beaver-drawer__mask ${R?"beaver-drawer--active":""} ${q}`.trim(),H=`beaver-drawer-wrapper beaver-drawer--${s} ${R?"beaver-drawer--active":""} ${z}`.trim(),L=`beaver-drawer__content ${E}`.trim(),A=e.jsxs("div",{ref:W,className:H,...P,children:[F&&e.jsx("div",{className:I,onClick:V,"aria-hidden":"true"}),e.jsxs("div",{ref:$,className:L,style:c,role:"complementary","aria-modal":"true","aria-labelledby":a?"beaver-drawer-title":void 0,children:[(a||j)&&e.jsx(S,{title:a,closable:j,onClose:r,id:a?"beaver-drawer-title":void 0}),e.jsx("div",{className:"beaver-drawer__body",children:_}),C!==null&&C!==!1?e.jsx(N,{children:C}):null]})]});return e.jsx(O,{children:A})});d.displayName="Drawer";d.__docgenInfo={description:"",methods:[],displayName:"Drawer",props:{open:{required:!1,tsType:{name:"boolean"},description:"控制Drawer是否打开",defaultValue:{value:"false",computed:!1}},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"关闭Drawer时的回调"},title:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Drawer标题"},width:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:`Drawer的宽度（水平方向）或高度（竖向方向），可以是px单位或百分比
...
@default true`,defaultValue:{value:"true",computed:!1}}}};const oe={title:"浮层（Overlays）/Drawer",component:d,tags:["autodocs"],parameters:{docs:{description:{component:`Drawer 组件
...
}`,...v.parameters?.docs?.source},description:{story:"自定义宽度Drawer",...v.parameters?.docs?.description}}};const ie=["Default","Placements","Sizes","WithFooter","LongContent","NoMask","NoTitle","NoCloseButton","CustomWidth"];export{v as CustomWidth,u as Default,y as LongContent,D as NoCloseButton,h as NoMask,g as NoTitle,f as Placements,w as Sizes,x as WithFooter,ie as __namedExportsOrder,oe as default};
