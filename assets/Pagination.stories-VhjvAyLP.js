...
- 支持国际化文案
- 支持对齐方式自定义（左、中、右）
- 支持受控和非受控用法`,methods:[],displayName:"Pagination",props:{total:{required:!0,tsType:{name:"number"},description:"总条目数"},pageSize:{required:!1,tsType:{name:"number"},description:"初始每页数量（可选，默认 10）",defaultValue:{value:"10",computed:!1}},current:{required:!1,tsType:{name:"number"},description:"受控当前页（可选）"},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(page: number, pageSize?: number) => void",signature:{arguments:[{type:{name:"number"},name:"page"},{type:{name:"number"},name:"pageSize"}],return:{name:"void"}}},description:"页码或 pageSize 变化回调"},pageSizeOptions:{required:!1,tsType:{name:"Array",elements:[{name:"number"}],raw:"number[]"},description:"下拉可选的 pageSize 值",defaultValue:{value:"[10, 20, 50, 100]",computed:!1}},showQuickJumper:{required:!1,tsType:{name:"boolean"},description:"是否显示快速跳转输入框",defaultValue:{value:"false",computed:!1}},showSizeChanger:{required:!1,tsType:{name:"boolean"},description:"是否显示每页数量切换器",defaultValue:{value:"false",computed:!1}},locale:{required:!1,tsType:{name:"Partial",elements:[{name:"signature",type:"object",raw:`{
  prev?: string;
  next?: string;
  jumpTo?: string;
  page?: string;
...
}`,signature:{properties:[{key:"sizeChanger",value:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}],required:!1}},{key:"quickJumper",value:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}],required:!1}}]}},description:"可选的宽度配置"}}};const X={title:"Components/Pagination",component:C,tags:["autodocs"],argTypes:{align:{control:{type:"radio"},options:["left","center","right"],description:"Alignment of the pagination container"}}},f={name:"默认",args:{total:234}},v={name:"带尺寸切换",args:{total:123,showSizeChanger:!0}},b={name:"带跳转",args:{total:78,showQuickJumper:!0}},x={name:"居中对齐",args:{total:100,align:"center"}},y={name:"右对齐",args:{total:100,align:"right"}},j={name:"英文",args:{total:150,showQuickJumper:!0,showSizeChanger:!0,locale:V,width:{sizeChanger:94}}},w={name:"禁用",args:{total:150,showQuickJumper:!0,showSizeChanger:!0,disabled:!0}},S={name:"受控",render:()=>{const[n,l]=t.useState(3);return a.jsxs("div",{children:[a.jsx(C,{total:200,current:n,onChange:s=>l(s)}),a.jsxs("div",{style:{marginTop:8},children:["当前页: ",String(n)]})]})}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  name: '默认',
  args: {
    total: 234
  }
...
}`,...S.parameters?.docs?.source}}};const Y=["Default","WithSizeChanger","WithQuickJumper","AlignCenter","AlignRight","WithEnglish","Disabled","Controlled"];export{x as AlignCenter,y as AlignRight,S as Controlled,f as Default,w as Disabled,j as WithEnglish,b as WithQuickJumper,v as WithSizeChanger,Y as __namedExportsOrder,X as default};
