...
}`,...N.parameters?.docs?.source},description:{story:"自定义按钮文本 - 显示不同的按钮标签",...N.parameters?.docs?.description}}};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  name: '位置',
  render: () => <div style={{
    display: 'flex',
...
}`,...I.parameters?.docs?.source},description:{story:"位置",...I.parameters?.docs?.description}}};M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
  name: '显示遮罩',
  render: () => <Popconfirm title="确定要执行此操作吗？" description="点击遮罩可关闭" showMask={true}>
      <Button variant="primary">操作</Button>
    </Popconfirm>
}`,...M.parameters?.docs?.source},description:{story:"显示遮罩 - showMask 为 true",...M.parameters?.docs?.description}}};O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  name: '禁用确认按钮',
...
模拟删除列表中的一项`,...z.parameters?.docs?.description}}};const me=["Basic","WithDescription","CustomButtonText","PlacementVariants","WithMask","OkDisabled","OkLoading","AsyncConfirm","Controlled","DeleteOperation"];export{q as AsyncConfirm,L as Basic,V as Controlled,N as CustomButtonText,z as DeleteOperation,O as OkDisabled,_ as OkLoading,I as PlacementVariants,S as WithDescription,M as WithMask,me as __namedExportsOrder,de as default};
