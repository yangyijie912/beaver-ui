...
- trigger: 'onChange' | 'onBlur' 指定验证触发时机`,...D.parameters?.docs?.description}}};q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
  ...
  render: () => {
    ...
    const HookControls = () => {
      ...
      return <div style={{
        marginTop: 12,
        border: '1px dashed var(--muted-4, #e6e6e6)',
        padding: 12
      }}>
          <div style={{
          marginBottom: 8
...
}`,...W.parameters?.docs?.source},description:{story:"完整的综合表单 - 包含库里所有主要表单组件",...W.parameters?.docs?.description}}};const Oe=["Default","HorizontalLayout","InlineLayout","Sizes","Disabled","ValidateWhenDisabled","AsyncValidation","DynamicFields","DependentFields","UseFormContextDemo","ProgrammaticControls","BeforeSubmitSync","BeforeSubmitAsync","ComprehensiveForm"];export{q as AsyncValidation,_ as BeforeSubmitAsync,P as BeforeSubmitSync,W as ComprehensiveForm,w as Default,O as DependentFields,N as Disabled,$ as DynamicFields,R as HorizontalLayout,T as InlineLayout,J as ProgrammaticControls,V as Sizes,z as UseFormContextDemo,D as ValidateWhenDisabled,Oe as __namedExportsOrder,$e as default};
