import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as m,r as N}from"./iframe-CIZpvQ1U.js";import{u as ie,a as p}from"./Form-C4Rfb4Ly.js";import{I as s}from"./Input-C8SVgGJd.js";import{B as n}from"./Button-C3h7FaaH.js";import{a as h}from"./Toast-A5JKIFWR.js";import{S as I}from"./Select-CqC-8JOr.js";import{C as re}from"./Checkbox-I-Se9L-U.js";import{a as ue,R as G}from"./Radio-BY00F6q6.js";import{S as ce}from"./Switch-C_csvV62.js";import{D as pe}from"./DatePicker-crz7Sqft.js";import{U as ve}from"./Upload-B6GV-sv1.js";import"./preload-helper-PPVm8Dsz.js";import"./client-DCamPumU.js";import"./index-DlnrNmRV.js";import"./index-B1Xph6y5.js";import"./Spinner-CKAoCXB_.js";import"./Info-BYSQShoX.js";import"./Close-IiX-HAFp.js";import"./Check-C9Lcua7d.js";import"./useMenuPosition-TViZUNcH.js";import"./floating-ui.dom-BnXNKGks.js";import"./ArrowRight-BvBKt8CZ.js";import"./Trash-CEBRM02O.js";const l=m.forwardRef(({className:r,name:a,label:t,required:d,rules:u=[],help:j,colon:C=!0,children:y,disabled:g,...v},F)=>{const c=ie(),[ne,he]=N.useState(!1),K=a&&c.errors[a],b=a?c.values[a]:void 0,B=(ne||!!c.submitAttempted)&&K,se=m.Children.toArray(y).some(o=>m.isValidElement(o)&&o.props?.disabled),ae=m.useMemo(()=>{const o=t&&(typeof t=="string"||typeof t=="number")?String(t):a?String(a):"该字段",i={validate:S=>S==null||typeof S=="string"&&S.trim()===""||Array.isArray(S)&&S.length===0?`${o}不能为空`:void 0,__isRequired:!0};return d?u&&u.length>0?[i,...u]:[i]:u},[u,d,t,a]);N.useEffect(()=>()=>{a&&c.unregisterField?.(a)},[a,c.unregisterField]),N.useEffect(()=>{if(a&&ae.length>0){const o=!!(se||g||c.disabled);c.registerField?.(a,ae,{disabled:o})}},[a,ae,se,g,c.disabled,c.registerField]);const oe=N.useCallback(o=>{if(a){let i;if(o&&typeof o=="object"&&"target"in o){const f=o.target,X=f.tagName,Z=X==="INPUT"&&(f.type==="checkbox"||f.type==="radio"),ee=X==="SELECT"&&f.multiple;Z?i=f.checked:ee?i=Array.from(f.selectedOptions,te=>te.value):i=f.value}else i=o;c.setFieldValue(a,i),c.getFieldRules(a).some(f=>f.trigger!=="onBlur")&&c.validateField(a)}},[a,c]),de=N.useCallback(o=>{he(!0),a&&c.validateField(a)},[a,c]),Q=["beaver-form-item"];d&&Q.push("beaver-form-item--required"),B&&Q.push("beaver-form-item--error"),r&&Q.push(r);const me=m.Children.map(y,o=>{if(m.isValidElement(o)){const i=o.props,S=o.type==="input"||o.type==="textarea"||o.type==="select",V=o.type?.displayName||"",f=V==="Checkbox",X=V==="Switch",Z=V==="DatePicker";if(S){const k=T=>{i.onChange&&i.onChange(T),oe(T)},ee=T=>{i.onBlur&&i.onBlur(T),de(T)},w=o.type==="input"&&(i.type==="checkbox"||i.type==="radio"),te=w&&i.checked===void 0,R=o.type==="select"&&!!i.multiple,le=!w&&i.value===void 0,x=(()=>{if(le)return R?b??[]:b!=null?String(b):""})();return m.cloneElement(o,{...i,...te?{checked:!!b}:{},...x!==void 0?{value:x}:{},onChange:k,onBlur:ee,disabled:i.disabled||g||c.disabled})}else{let k="none";const w=i.style?.width;B?k="error":ne&&!K&&b&&(k="none");const R={onChange:x=>{i.onChange&&i.onChange(x),oe(x)},onBlur:x=>{i.onBlur&&i.onBlur(x),de(x)},disabled:i.disabled||g||c.disabled,validation:i.validation||k,...w!==void 0&&i.width===void 0?{width:w}:{}};if(!f&&!Z&&(R.size=i.size||c.size),f||X){const x=i.checked===void 0;return m.cloneElement(o,{...i,...R,...x?{checked:!!b}:{}})}if(Z){const x=b instanceof Date||b===null?b:void 0,T=i.value===void 0;return m.cloneElement(o,{...i,...R,...T?{value:x}:{}})}const le=i.value===void 0;return m.cloneElement(o,{...i,...R,...le?{value:b??""}:{}})}}return o}),ye=c.layout==="inline";return e.jsxs("div",{ref:F,className:Q.join(" "),...v,children:[t&&e.jsxs("label",{className:"beaver-form-item__label",children:[d&&e.jsx("span",{className:"beaver-form-item__required-mark",children:"*"}),e.jsx("span",{children:t}),C&&e.jsx("span",{className:"beaver-form-item__colon",children:":"})]}),ye?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"beaver-form-item__control",children:me}),e.jsx("div",{className:"beaver-form-item__error-message",children:B?K:""}),e.jsx("div",{className:"beaver-form-item__help",children:j&&!B?j:""})]}):e.jsxs("div",{className:"beaver-form-item__control",children:[me,e.jsx("div",{className:"beaver-form-item__error-message",children:B?K:""}),e.jsx("div",{className:"beaver-form-item__help",children:j&&!B?j:""})]})]})});l.displayName="FormItem";l.__docgenInfo={description:"",methods:[],displayName:"FormItem",props:{name:{required:!1,tsType:{name:"string"},description:"字段名"},label:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"标签文本"},required:{required:!1,tsType:{name:"boolean"},description:"是否必填（会显示红色 * 标记）"},disabled:{required:!1,tsType:{name:"boolean"},description:"字段禁用（可用于在 FormItem 中标记字段为 disabled）"},rules:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
...
}`,...q.parameters?.docs?.source},description:{story:"水平布局（标签在左，输入框在右）",...q.parameters?.docs?.description}}};O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  name: '行内布局',
  render: () => {
    const handleSubmit = (values: any) => {
      console.log('提交的数据:', values);
...
}`,...O.parameters?.docs?.source},description:{story:"行内布局（所有字段在一行）",...O.parameters?.docs?.description}}};$.parameters={...$.parameters,docs:{...$.parameters?.docs,source:{originalSource:`{
  name: '不同尺寸',
  render: () => {
...
}`,...$.parameters?.docs?.source},description:{story:"不同尺寸",...$.parameters?.docs?.description}}};z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  name: '禁用状态',
  render: () => {
    return <div>
        <div style={{
...
}`,...z.parameters?.docs?.source},description:{story:"禁用状态",...z.parameters?.docs?.description}}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  name: '自定义验证',
  render: () => {
    const handleSubmit = (values: any) => {
...
}`,..._.parameters?.docs?.source},description:{story:"字段依赖示例：根据一个字段值调整另一个字段的校验规则",..._.parameters?.docs?.description}}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
...
}`,...A.parameters?.docs?.source},description:{story:"useFormContext 演示\n- 展示如何在子组件中通过 hook 访问 `form` 对象（values、errors 等）\n- 演示 programmatic setFieldsValue、reset 和触发校验",...A.parameters?.docs?.description}}};W.parameters={...W.parameters,docs:{...W.parameters?.docs,source:{originalSource:`{
  name: '使用ref控制',
  render: () => {
    const formRef = React.useRef<any>(null);
    const handleSubmit = (values: any) => {
...
}`,...W.parameters?.docs?.source},description:{story:"使用 ref 进行程序化控制（reset / setFieldsValue）",...W.parameters?.docs?.description}}};L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
  name: '提交前拦截（同步）',
  render: () => {
    const handleSubmit = (values: any) => {
      Toast.success(JSON.stringify(values, null, 2), {
...
}`,...H.parameters?.docs?.source},description:{story:"外部受控（多选）示例：父组件显式传入 value/onChange",...H.parameters?.docs?.description}}};const We=["Default","HorizontalLayout","InlineLayout","Sizes","Disabled","ValidateWhenDisabled","AsyncValidation","DynamicFields","DependentFields","UseFormContextDemo","ProgrammaticControls","BeforeSubmitSync","BeforeSubmitAsync","ComprehensiveForm","NativeElements","ExternallyControlledMultiple"];export{J as AsyncValidation,M as BeforeSubmitAsync,L as BeforeSubmitSync,Y as ComprehensiveForm,D as Default,_ as DependentFields,z as Disabled,P as DynamicFields,H as ExternallyControlledMultiple,q as HorizontalLayout,O as InlineLayout,U as NativeElements,W as ProgrammaticControls,$ as Sizes,A as UseFormContextDemo,E as ValidateWhenDisabled,We as __namedExportsOrder,Ae as default};
