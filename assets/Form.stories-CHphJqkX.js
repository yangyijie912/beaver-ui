...
}`,...z.parameters?.docs?.source},description:{story:"禁用状态",...z.parameters?.docs?.description}}};P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  name: '自定义验证',
  render: () => {
    const handleSubmit = (values: any) => {
...
- trigger: 'onChange' | 'onBlur' 指定验证触发时机`,...P.parameters?.docs?.description}}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  name: '异步校验',
  render: () => {
    const handleSubmit = (values: any) => {
...
}`,...E.parameters?.docs?.source},description:{story:"异步校验示例",...E.parameters?.docs?.description}}};J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
  name: '动态字段（增/删）',
  render: () => {
    const formRef = React.useRef<any>(null);
...
}`,...J.parameters?.docs?.source},description:{story:"动态字段示例：演示增删字段并校验",...J.parameters?.docs?.description}}};_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  name: '字段依赖',
  render: () => {
    const handleSubmit = (values: any) => {
...
}`,...H.parameters?.docs?.source},description:{story:"外部受控（多选）示例：父组件显式传入 value/onChange",...H.parameters?.docs?.description}}};const Le=["Default","HorizontalLayout","InlineLayout","Sizes","Disabled","ValidateWhenDisabled","AsyncValidation","DynamicFields","DependentFields","UseFormContextDemo","ProgrammaticControls","BeforeSubmitSync","BeforeSubmitAsync","ComprehensiveForm","NativeElements","ExternallyControlledMultiple"];export{E as AsyncValidation,M as BeforeSubmitAsync,L as BeforeSubmitSync,Y as ComprehensiveForm,D as Default,_ as DependentFields,z as Disabled,J as DynamicFields,H as ExternallyControlledMultiple,q as HorizontalLayout,O as InlineLayout,U as NativeElements,W as ProgrammaticControls,$ as Sizes,A as UseFormContextDemo,P as ValidateWhenDisabled,Le as __namedExportsOrder,We as default};
