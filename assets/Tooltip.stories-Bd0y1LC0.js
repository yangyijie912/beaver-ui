import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-DrRAcTtF.js";import{r as V}from"./index-Ci4OHB6e.js";import{B as l}from"./Button-1jTwx0M_.js";import"./preload-helper-PPVm8Dsz.js";import"./index-CK-JP5ii.js";const n=({content:m,placement:d="top",children:N,portal:I=!0})=>{const B=p.useId(),T=p.useRef(null),E=p.useRef(null),[_,C]=p.useState(!1),w=_,[H,S]=p.useState({}),f=!(m==null||typeof m=="string"&&m.trim()===""),y=8;p.useEffect(()=>{if(!f)return;const t=T.current;if(!t)return;const c=()=>C(!0),a=()=>C(!1);return t.addEventListener("mouseenter",c),t.addEventListener("mouseleave",a),t.addEventListener("focus",c),t.addEventListener("blur",a),()=>{t.removeEventListener("mouseenter",c),t.removeEventListener("mouseleave",a),t.removeEventListener("focus",c),t.removeEventListener("blur",a)}},[f]),p.useEffect(()=>{if(!w)return;const t=()=>{const c=T.current,a=E.current;if(!c||!a)return;const r=c.getBoundingClientRect(),u=a.offsetWidth,v=a.offsetHeight;let o=0,i=0;d==="top"?(o=r.top-y-v,i=r.left+r.width/2-u/2):d==="bottom"?(o=r.bottom+y,i=r.left+r.width/2-u/2):d==="left"?(o=r.top+r.height/2-v/2,i=r.left-y-u):(o=r.top+r.height/2-v/2,i=r.right+y);const s=8,L=window.innerWidth,P=window.innerHeight;i<s&&(i=s),i+u>L-s&&(i=L-s-u),o<s&&(o=s),o+v>P-s&&(o=P-s-v),S({left:Math.round(i),top:Math.round(o)})};return t(),window.addEventListener("scroll",t,!0),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t,!0),window.removeEventListener("resize",t)}},[w,d]);const D=e.jsx("span",{className:"beaver-tooltip__trigger",ref:T,"aria-describedby":f?B:void 0,tabIndex:0,children:N}),R=f?e.jsxs("div",{ref:E,role:"tooltip",id:B,className:"beaver-tooltip__content","data-placement":d,"data-state":w?"visible":"hidden",style:H,children:[e.jsx("div",{className:"beaver-tooltip__inner",children:m}),e.jsx("div",{className:"beaver-tooltip__arrow","data-placement":d})]}):null;return e.jsxs("span",{className:`beaver-tooltip beaver-tooltip--placement-${d}`,children:[D,I&&R?V.createPortal(R,document.body):R]})};n.__docgenInfo={description:"",methods:[],displayName:"Tooltip",props:{content:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"要展示的内容，可以是字符串或 React 节点"},placement:{required:!1,tsType:{name:"union",raw:"'top' | 'bottom' | 'left' | 'right'",elements:[{name:"literal",value:"'top'"},{name:"literal",value:"'bottom'"},{name:"literal",value:"'left'"},{name:"literal",value:"'right'"}]},description:"显示位置，默认为 `top`",defaultValue:{value:"'top'",computed:!1}},children:{required:!0,tsType:{name:"ReactReactElement",raw:"React.ReactElement"},description:"子元素：触发 Tooltip 的元素（通常是按钮或文本）"},portal:{required:!1,tsType:{name:"boolean"},description:"是否通过 portal 渲染到 body（默认 true，避免被父容器裁剪）",defaultValue:{value:"true",computed:!1}}}};const O={title:"Components/Tooltip",component:n,tags:["autodocs"],parameters:{docs:{description:{component:`Tooltip 组件
- 使用场景：为元素提供简洁的文字提示信息
- 支持多种位置（上/下/左/右）
- 支持 React 节点内容
- 支持 portal 渲染，避免裁切问题
