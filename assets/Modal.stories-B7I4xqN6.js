...
}`,...S.parameters?.docs?.source},description:{story:"可以自行覆盖CSS来改写动画效果",...S.parameters?.docs?.description}}};const se=["Default","NoTitle","NoClosable","MaskNotClosable","Small","Medium","Large","CustomWidth","LongContent","CustomFooter","NoFooter","NoHeader","OnOkDefault","Interactive","AnimationSlow"];export{S as AnimationSlow,C as CustomFooter,y as CustomWidth,p as Default,k as Interactive,M as Large,v as LongContent,f as MaskNotClosable,h as Medium,m as NoClosable,j as NoFooter,g as NoHeader,u as NoTitle,O as OnOkDefault,x as Small,se as __namedExportsOrder,re as default};
