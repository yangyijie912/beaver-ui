import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as h}from"./iframe-CIZpvQ1U.js";import{I as a}from"./Input-C8SVgGJd.js";import"./preload-helper-PPVm8Dsz.js";const z={title:"表单（Form）/Input",component:a,tags:["autodocs"],decorators:[m=>e.jsx("div",{style:{width:300},children:e.jsx(m,{})})],parameters:{docs:{description:{component:`Input 组件
- 使用场景：接收用户的文本输入
- 支持多行文本输入（textarea）
- 支持输入校验状态（错误、成功）
- 支持禁用状态
