...
@default true`,defaultValue:{value:"true",computed:!1}}}};const se={title:"浮层（Overlays）/Drawer",component:d,tags:["autodocs"],parameters:{docs:{description:{component:`Drawer 组件
...
}`,...v.parameters?.docs?.source},description:{story:"自定义宽度Drawer",...v.parameters?.docs?.description}}};const oe=["Default","Placements","Sizes","WithFooter","LongContent","NoMask","NoTitle","NoCloseButton","CustomWidth"];export{v as CustomWidth,u as Default,y as LongContent,D as NoCloseButton,h as NoMask,g as NoTitle,f as Placements,w as Sizes,x as WithFooter,oe as __namedExportsOrder,se as default};
