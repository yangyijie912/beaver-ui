...
}`,...u.parameters?.docs?.source},description:{story:`无左侧边框
当不需要左侧颜色条时可以使用`,...u.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  name: '可关闭',
  render: () => {
...
点击关闭按钮将隐藏该提示`,...g.parameters?.docs?.description}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  name: '自定义图标',
  render: () => <div style={{
    display: 'flex',
    flexDirection: 'column',
...
可以使用任意内容替换默认图标`,...y.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  name: '自定义关闭按钮',
  render: () => {
...
}`,...f.parameters?.docs?.source},description:{story:`自定义关闭按钮
可以使用自定义的关闭按钮样式`,...f.parameters?.docs?.description}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  name: '长内容',
  args: {
    type: 'warning',
    title: '重要通知',
...
同时展示所有四种类型的提示，便于对比`,...b.parameters?.docs?.description}}};const L=["Default","Success","Warning","Error","Info","MessageOnly","WithTitleAndMessage","Compact","NoBorder","Closable","CustomIcon","CustomCloseIcon","LongContent","AllTypes"];export{b as AllTypes,g as Closable,p as Compact,f as CustomCloseIcon,y as CustomIcon,a as Default,l as Error,c as Info,v as LongContent,d as MessageOnly,u as NoBorder,i as Success,n as Warning,m as WithTitleAndMessage,L as __namedExportsOrder,k as default};
