import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as g}from"./iframe-BihDZwrr.js";import{I as r}from"./Input--HnKrK-W.js";import"./preload-helper-PPVm8Dsz.js";import"./Eye-OPWQ-oqv.js";const V={title:"表单（Form）/Input",component:r,tags:["autodocs"],decorators:[a=>e.jsx("div",{style:{width:300},children:e.jsx(a,{})})],parameters:{docs:{description:{component:`Input 组件
- 使用场景：接收用户的文本输入
- 支持多行文本输入（textarea）
- 支持输入校验状态（错误、成功）
- 支持禁用状态
